...
import useEmailGroupAdd from "./useEmailGroupAdd";
...
export default {
  ...
  setup() {
    const EMAIL_GROUP_ADD_APP_STORE_MODULE_NAME = "email-group-add";

    // Register module
    if (!store.hasModule(EMAIL_GROUP_ADD_APP_STORE_MODULE_NAME))
      store.registerModule(
        EMAIL_GROUP_ADD_APP_STORE_MODULE_NAME,
    ...
    onUnmounted(() => {
      if (store.hasModule(EMAIL_GROUP_ADD_APP_STORE_MODULE_NAME))
        store.unregisterModule(EMAIL_GROUP_ADD_APP_STORE_MODULE_NAME);
    });
