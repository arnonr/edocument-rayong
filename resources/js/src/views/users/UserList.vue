  ...
  <div>
    <b-card>
      <b-row>
        ...
        <b-col md="4">
          <b-form-group label="ชื่อ" label-for="">
            <b-form-input
              id="firstname"
         ...
         <b-col md="4">
          <b-form-group label="นามสกุล" label-for="">
            <b-form-input
              id="lastname"
              v-model="advancedSearch.lastname"
              placeholder="นามสกุล"
            />
          </b-form-group>
        </b-col>
        ...
        <b-col md="4">
          <b-form-group label="เมล" label-for="">
            <b-form-input
              id="title"
        ...
        <b-col md="4">
          <b-form-group label="ฝ่าย" label-for="">
            <v-select
        ...
        <b-col md="4">
          <b-form-group label="ประเภทผู้ใช้งาน" label-for="">
            <v-select
              v-model="advancedSearch.typeName"
              :dir="$store.state.appConfig.isRTL ? 'rtl' : 'ltr'"
              label="title"
              placeholder="-- ประเภท --"
              :clearable="false"
         ...
         <b-col md="4">
          <b-form-group label="สถานะ" label-for="">
            <v-select
        ...
        <b-col cols="12">
          ...
          >
            ...
            <template #cell(statusName)="row">
              <b-button
                :variant="`${resolveStatusVariant(row.item.statusName)}`"
                alt="Status"
                title="Status"
                class="btn-icon"
              >
...
export default {
  ...
  setup() {
    const USER_LIST_APP_STORE_MODULE_NAME = "user-list";

    // Register module
    if (!store.hasModule(USER_LIST_APP_STORE_MODULE_NAME))
      store.registerModule(
        USER_LIST_APP_STORE_MODULE_NAME,
        userListStoreModule
      );
    ...
    onUnmounted(() => {
      if (store.hasModule(USER_LIST_APP_STORE_MODULE_NAME))
        store.unregisterModule(USER_LIST_APP_STORE_MODULE_NAME);
    });
