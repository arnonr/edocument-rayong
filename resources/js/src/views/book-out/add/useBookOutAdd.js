  ...
  watch(
    ...
    (newData) => {
      if (newData != null) {
        ...
        bookOutData.bookTo = [...bookOutData.bookTo, ...bookToWithGroupFilter];
      }
    }
  );
  ...
  watch(
    ...
    (newData) => {
      if (newData != null) {
        ...
        if (count == 1) {
          if (bookOutData.bookType.code == 5) {
            codeLastest = "0" + codeLastest;
          } else if (bookOutData.bookType.code == 1) {
        ...
        if (count == 3) {
          if (bookOutData.bookType.code == 1) {
            codeLastest = "0" + codeLastest;
          }
        }
        ...
        let book = "";
        let book1 = "";
        if (bookOutData.bookType.code == 4) {
          book = bookOutData.bookType.acronym + "/" + codeLastest;

          book1 = bookOutData.bookType.acronym + "/" + codeLastest1;
        } else {
          book =
