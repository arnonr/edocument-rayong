...
import useEmailPersonAdd from "./useEmailPersonAdd";
...
export default {
  ...
  setup() {
    const EMAIL_PERSON_ADD_APP_STORE_MODULE_NAME = "email-person-add";

    // Register module
    if (!store.hasModule(EMAIL_PERSON_ADD_APP_STORE_MODULE_NAME))
      store.registerModule(
        EMAIL_PERSON_ADD_APP_STORE_MODULE_NAME,
    ...
    onUnmounted(() => {
      if (store.hasModule(EMAIL_PERSON_ADD_APP_STORE_MODULE_NAME))
        store.unregisterModule(EMAIL_PERSON_ADD_APP_STORE_MODULE_NAME);
    });
