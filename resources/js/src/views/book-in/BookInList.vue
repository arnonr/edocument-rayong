...
export default {
  ...
  setup() {
    const BOOK_IN_APP_STORE_MODULE_NAME = "book-in";

    // Register module
    if (!store.hasModule(BOOK_IN_APP_STORE_MODULE_NAME))
      store.registerModule(BOOK_IN_APP_STORE_MODULE_NAME, bookInStoreModule);
    ...
    store
      .dispatch("book-in/fetchBookInCategories")
      .then((response) => {
    ...
    const fetchBookTypes = (book_in_category_id) => {
      ...
      store
        .dispatch("book-in/fetchBookInTypes", {
    ...
    store
      .dispatch("book-in/fetchDepartments")
      .then((response) => {
        const { data } = response.data;
          ...
          <b-row>
            <b-col>
              <b-button
                ...
                @click="$router.push({ name: 'book-in-add' })"
              ...
              <b-button
                ...
                @click="$router.push({ name: 'book-in-old' })"
