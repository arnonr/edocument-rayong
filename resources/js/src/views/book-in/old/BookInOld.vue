            ...
            <b-row>
                <b-col cols="12" md="12">
                    <b-button
                        ...
                        variant="success"
                        class="mb-sm-0 mr-0"
                        @click="$router.push({ name: 'bookin-old-add', query: {year: yearID.code}})"
                        :block="
...
import useBookInOld from "./useBookInOld";
...
export default {
    ...
    setup() {
        ...
        onUnmounted(() => {
            if (store.hasModule(BOOK_IN_OLD_APP_STORE_MODULE_NAME))
                store.unregisterModule(BOOK_IN_OLD_APP_STORE_MODULE_NAME);
        });
